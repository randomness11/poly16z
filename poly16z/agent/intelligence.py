...
from poly16z.agent.base import BaseAgent, Observation
from poly16z.api.client import PolymarketClient, Market
...
class IntelligenceAgent(BaseAgent):
    ...
    def __init__(
        ...
        if perplexity_api_key:
            try:
                from poly16z.sources.perplexity import PerplexityClient
        ...
        if enable_sentiment:
            try:
                from poly16z.sources.sentiment import SentimentAnalyzer
