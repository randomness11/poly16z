...
async def test_imports():
    ...
    try:
        from poly16z.web.app import create_app
        print("  ✅ web.app imported")

        from poly16z.web.server import run_server_with_agent
        print("  ✅ web.server imported")

        from poly16z.web.api.routes import router
        print("  ✅ web.api.routes imported")

        from poly16z.web.api.websocket import manager, websocket_endpoint
        print("  ✅ web.api.websocket imported")

        from poly16z.web.api.models import StatusResponse, TradeResponse
...
async def test_database_integration():
    ...
    try:
        from poly16z.storage.database import get_db_manager, initialize_database
        from poly16z.storage.models import TradeRecord, ObservationRecord, DecisionRecord
...
async def test_mock_agent_state():
    ...
    try:
        from poly16z.web.app import set_agent_state, get_agent_state
        from poly16z.agent.base import BaseAgent, AgentMemory, Observation, Decision
...
async def test_api_endpoints():
    ...
    try:
        from datetime import datetime
        from poly16z.web.api.models import (
            StatusResponse,
            TradeResponse,
            PerformanceResponse,
            EquityCurvePoint,
...
async def main():
    """Run all tests."""
    print("=" * 60)
    print("🚀 poly16z Backend Test Suite")
    print("=" * 60)
    ...
    if passed == total:
        ...
        print("  2. Run: python poly16z/main.py --strategy custom --agent openai --dry-run")
