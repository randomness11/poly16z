...
# Add project root to path (poly16z package is at <root>/poly16z)
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "../..")))

from loguru import logger
from poly16z.api.client import PolymarketClient
from poly16z.risk.manager import RiskManager
from poly16z.agent.mock_agent import create_mock_agent_factory
from poly16z.backtesting.optimizer import (
    StrategyOptimizer,
    ParameterRange,
