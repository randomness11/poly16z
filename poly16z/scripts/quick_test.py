...
try:
    ...
    from poly16z.web.api.models import StatusResponse, TradeResponse, PerformanceResponse
...
try:
    from poly16z.web.api.websocket import ConnectionManager
...
print("\n   2. Start the bot:")
print("      cd ~/polymarket-ai-bot/poly16z")
