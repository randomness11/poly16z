...
Main FastAPI app for the poly16z dashboard.
"""
...
from poly16z.web.api.routes import router as api_router
from poly16z.web.api.websocket import websocket_endpoint
...
def create_app() -> FastAPI:
    ...
    @app.get("/")
    async def root():
        return {"message": "poly16z Dashboard API", "version": "1.0.0"}
