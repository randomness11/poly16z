...
def parse_args():
    ...
    parser.add_argument("--days", type=int, default=30, help="Days of synthetic data for testing")
    parser.add_argument(
        "--simulations", type=int, default=50, help="Number of Monte Carlo simulations"
    )
    parser.add_argument(
        "--metric",
        type=str,
...
async def main():
    ...
    mc_results = await optimizer.monte_carlo(result.best_params, num_simulations=args.simulations)
